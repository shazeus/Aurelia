...
(function createFakeChromaButton() {
  ...
  const CSS_RULES = `
    ...
    .${PANEL_CLASS} .aurelia-flyout-header {
      position: relative;
      z-index: 1;
    ...
    .${PANEL_CLASS} .aurelia-flyout-kicker {
      color: #c89b3c;
    ...
    .${PANEL_CLASS} .aurelia-flyout-title-row {
      display: flex;
    ...
    .${PANEL_CLASS} .aurelia-flyout-title {
      min-width: 0;
      color: #f0e6d2;
    ...
    .${PANEL_CLASS} .aurelia-flyout-count {
      flex: 0 0 auto;
      color: #a09b8c;
      font-family: "LoL Body", Arial, sans-serif;
      font-size: 11px;
    ...
    .${PANEL_CLASS} .aurelia-flyout-subtitle {
      color: #a09b8c;
      font-family: "LoL Body", Arial, sans-serif;
      font-size: 11px;
      line-height: 1.3;
  ...
  function createChromaPanel(skinData, chromas, buttonElement) {
    ...
    modal.className = "champ-select-chroma-modal chroma-modal chroma-view ember-view aurelia-enhanced-flyout";
    ...
    header.className = "aurelia-flyout-header";
    const headerKicker = document.createElement("div");
    headerKicker.className = "aurelia-flyout-kicker";
    headerKicker.textContent = "shazeus aurelia";
    const headerTitleRow = document.createElement("div");
    headerTitleRow.className = "aurelia-flyout-title-row";
    const headerTitle = document.createElement("div");
    headerTitle.className = "aurelia-flyout-title";
    ...
    headerCount.className = "aurelia-flyout-count";
    headerCount.textContent = `${chromas.length} option${chromas.length === 1 ? "" : "s"}`;
    const headerSubtitle = document.createElement("div");
    headerSubtitle.className = "aurelia-flyout-subtitle";
  ...
  function subscribeToSkinMonitor() {
    ...
    if (window.__aureliaSkinState) {
      skinMonitorState = window.__aureliaSkinState;
