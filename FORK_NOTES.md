...
- GitHub-facing links in the README, installer metadata, plugin metadata, and updater point to `shazeus/Aurelia`.
- The in-client settings panel removes the GitHub action link and points support/donation actions to GitHub Sponsors.
